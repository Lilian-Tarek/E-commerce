...
const images = [
  "https://plus.unsplash.com/premium_photo-1668485968660-67a0f563d59a?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  "/images/pexels-annetnavi-789303.jpg",
  "/images/pexels-annetnavi-840565.jpg"
];
const Landing = () => {
  return (
      ...
      <div className="w-full lg:w-1/3 pt-5 md:pt-10 z-10 lg:text-start text-center">
        ...
        <div className="flex flex-col sm:flex-row md:items-center gap-4 lg:justify-start justify-center">
          <button className="flex items-center justify-between gap-6 md:gap-10 px-6 py-3 bg-secondary hover:bg-gray-300 transition w-full sm:w-auto">
            <Link className=" text-lg text-primary font-bold" to="/categories">Go To Shop</Link>
