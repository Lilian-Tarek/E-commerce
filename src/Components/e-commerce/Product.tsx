...
const Product = memo(({ id, title, cat_prefix, price, img, max, quantity, isLiked,isAuthenticated}: TProductItem) => {
 ...
 dispatch(ActLikes(id))
  ...
  return (
    <>
      ...
      <div className="relative border-1 border-primary rounded  ">
        <div className="">
          <div
          ...
          >
            {IsLoading ? (
              ...
              <FaHeart className="text-3xl absolute right-2 top-2 text-accent" />
            ) : (
              <CiHeart className="text-3xl absolute  right-2 top-2 text-accent" />
            )}
          </div>
          <img
